...
To integrate this pod, please add `pod 'GrowingReactNativeKit'` into your Podfile target(s). Here's an example:
...
安装前您可以执行命令 ```pod spec cat GrowingReactNativeKit``` 看一下，从这个命令的输出里可以看到我们当前的版本号，您可以对照着看一下。   
